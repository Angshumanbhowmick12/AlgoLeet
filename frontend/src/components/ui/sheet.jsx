  ...
  return (
    <SheetPortal>
      ...
      >
        {children}
        {/*
          FIX: Added 'asChild' to SheetPrimitive.Close and wrapped its content in a <button>.
          This tells Radix to merge its props onto the <button> element,
          ensuring correct ref forwarding and accessibility.
        */}
